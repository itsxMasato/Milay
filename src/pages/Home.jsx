...
export default function Home() {
  ...
  const getFullWhatsAppLink = (value) => {
    if (!value) return '';
  ...
  const loyaltyCardStamps = lookupResult ? Number(lookupResult.sellos) || 0 : 0;
  const loyaltyCardName = lookupResult?.nombre || 'Tu nombre aquí';
  const loyaltyCardCode = lookupResult?.code || 'MB-0000';
  const formattedWhatsappLink = getFullWhatsAppLink(pageData.socialWhatsapp);
    ...
    <>
      ...
      <div className="social-strip">
        {pageData.socialInstagram && (
          <a href={pageData.socialInstagram.startsWith('http') ? pageData.socialInstagram : `https://instagram.com/${pageData.socialInstagram.replace('@', '')}`} target="_blank" rel="noreferrer" className="social-link">
        ...
        {formattedWhatsappLink && (
          <a href={formattedWhatsappLink} target="_blank" rel="noreferrer" className="social-link">
      ...
      <div id="nosotras">
        <div className="inner">
          ...
          <div className="about-text">
            ...
            <a href={formattedWhatsappLink} target="_blank" rel="noreferrer" className="btn btn-primary" style={{ marginTop: '1.5rem', display: 'inline-flex' }}>
              Reservar cita
            </a>
          </div>
        </div>
          ...
          <div className="loyalty-layout">
            <div>
              <div className="loyalty-card-visual">
                ...
                <div className="card-stamps">{renderStamps(loyaltyCardStamps)}</div>
                <div className="card-bottom">
                  <span className="card-name">{loyaltyCardName}</span>
                  <span className="card-number">#{loyaltyCardCode}</span>
                </div>
              </div>
          ...
          <div className="footer-info">
            ...
            {(pageData.footerPhone || pageData.footerEmail || pageData.socialWhatsapp) && (
              <div className="footer-section">
                ...
                {formattedWhatsappLink && (
                  <p>
                    WhatsApp: <a href={formattedWhatsappLink} target="_blank" rel="noreferrer">Enviar mensaje</a>
                  </p>
                )}
              </div>
            )}
